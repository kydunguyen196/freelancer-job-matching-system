...
@TestPropertySource(properties = {
		"spring.datasource.url=jdbc:h2:mem:proposaldb;MODE=PostgreSQL;DB_CLOSE_DELAY=-1;DB_CLOSE_ON_EXIT=FALSE",
		...
		"app.services.job-base-url=http://localhost:8083",
		"app.services.contract-base-url=http://localhost:8085",
